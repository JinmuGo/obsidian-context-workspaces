...
import type { ContextSpacesPlugin, EmojiData, ThemeMode } from '../types';
import {
	applySpaceTheme,
	getAvailableThemes,
	getCurrentTheme,
...
export const SpaceEditModal: React.FC<SpaceEditModalProps> = ({
			...
			if (isCurrentSpace && (updatedSpace.theme || updatedSpace.themeMode)) {
				try {
					...
					setTimeout(() => {
						...
						console.log('Context Spaces: Theme changes applied and UI refreshed');
					}, 100);
				} catch (error) {
	...
	return (
		<div className="obsidian-context-spaces-modal-container">
			...
			/>
			<div className="obsidian-context-spaces-modal-content obsidian-context-spaces-edit-modal">
				<div className="obsidian-context-spaces-modal-body">
					{/* Space name and icon in one row */}
					<div className="obsidian-context-spaces-name-icon-container">
						{/* Icon button */}
						<div className="obsidian-context-spaces-icon-container">
							<label htmlFor={emojiPickerId}>Emoji:</label>
							<button
								id={emojiPickerId}
								type="button"
								className="obsidian-context-spaces-icon-picker-button"
							...
							{showEmojiPicker && (
								<div
									ref={emojiPickerRef}
									className="obsidian-context-spaces-emoji-picker-popup"
								>
									<EmojiPicker
						...
						{/* Space name input */}
						<div className="obsidian-context-spaces-name-container">
				...
				<div className="obsidian-context-spaces-modal-footer">
					<div className="obsidian-context-spaces-modal-button-container">
