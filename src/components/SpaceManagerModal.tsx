...
import type { ContextSpacesPlugin } from '../types';
...
export const SpaceManagerModal: React.FC<SpaceManagerModalProps> = ({
	...
	return (
		<div className="obsidian-context-spaces-modal-container">
			...
			/>
			<div className="obsidian-context-spaces-modal-content obsidian-context-spaces-manager-modal">
				<div className="obsidian-context-spaces-modal-body">
					<div className="obsidian-context-spaces-space-list">
						{spaceOrder.map((spaceId: string) => {
							const space = spaces[spaceId];
							if (!space) return null;

							return (
								<div key={spaceId} className="obsidian-context-spaces-space-item">
									<div className="obsidian-context-spaces-space-info">
										<h3 data-icon={space.icon || '📄'}>{space.name}</h3>

										{/* Description */}
										{space.description && (
											<p className="obsidian-context-spaces-space-description">
												{space.description}
											</p>
										)}

										{/* Auto-save info */}
										<p className="obsidian-context-spaces-auto-save-info">
										...
										{(() => {
											...
											if (themeInfo.length > 0) {
												return (
													<p className="obsidian-context-spaces-theme-info">
														{themeInfo.join(', ')}
													</p>
												);
											}
									...
									<div className="obsidian-context-spaces-space-actions">
										{/* Auto-save toggle */}
										...
										<button
											type="button"
											className="obsidian-context-spaces-button obsidian-context-spaces-warning"
