...
import type { ContextSpacesPlugin, SpaceConfig } from '../types';
...
const SpaceItem: React.FC<SpaceItemProps> = ({
	...
	return (
		<div
			ref={setNodeRef}
			style={style}
			className={`obsidian-context-spaces-settings-item ${isActive ? 'active' : ''} ${isDragging ? 'obsidian-context-spaces-dragging' : ''}`}
		>
			{/* Drag handle */}
			<div className="obsidian-context-spaces-drag-handle" {...attributes} {...listeners}>
				⋮⋮
			</div>

			{/* Main row with title, current label, and auto-save */}
			<div className="obsidian-context-spaces-item-main-row">
				{/* Left side: title and current label */}
				<div className="obsidian-context-spaces-item-left">
					<div className="obsidian-context-spaces-item-title-container">
						<span className="obsidian-context-spaces-item-icon">
							{space.icon || '📄'}
						</span>
						<span className="obsidian-context-spaces-item-name">{space.name}</span>
					</div>

					{isActive && (
						<span className="obsidian-context-spaces-current-badge">CURRENT</span>
					)}
				</div>

				{/* Right side: auto-save toggle */}
				<div className="obsidian-context-spaces-item-right">
					<div className="obsidian-context-spaces-auto-save-container">
						<span>Auto-save</span>

						<div className="obsidian-context-spaces-tooltip-container">
							<button
								type="button"
								className={`obsidian-context-spaces-switch-toggle ${space.autoSave ? 'active' : ''}`}
							...
							<div className="obsidian-context-spaces-tooltip">
								{space.autoSave
			...
			<div className="obsidian-context-spaces-item-description-row">
				{/* Description */}
				<div className="obsidian-context-spaces-item-description">
					{space.description || 'No description'}
				</div>

				{/* Action buttons on the right */}
				<div className="obsidian-context-spaces-action-buttons">
					{/* Edit button */}
					<button
						type="button"
						className="obsidian-context-spaces-button obsidian-context-spaces-cta obsidian-context-spaces-action-btn"
					...
					<button
						type="button"
						className="obsidian-context-spaces-button obsidian-context-spaces-warning obsidian-context-spaces-action-btn"
...
interface ContextSpacesSettingTabProps {
	app: unknown;
	plugin: ContextSpacesPlugin;
	containerEl: HTMLElement;
}

export const ContextSpacesSettingTab: React.FC<ContextSpacesSettingTabProps> = ({
	app,
	plugin,
}) => {
	...
	if (!isWorkspacesPluginEnabled(plugin.app as App)) {
		return (
			<div className="obsidian-context-spaces-settings">
				<h2>Context Spaces Settings</h2>
				<div className="obsidian-context-spaces-settings-disabled">
					<h3>Enable Obsidian Workspaces core plugin</h3>
					<p>
						Context Spaces depends on Obsidian's Workspaces core plugin. Please enable
					...
					<div className="obsidian-context-spaces-setting-item-description">
	...
	return (
		<DndProvider onDragEnd={handleDragEnd} items={spaceOrder}>
			<div className="obsidian-context-spaces-settings">
				...
				<div className="obsidian-context-spaces-settings-header">
					<h3>Spaces List</h3>
					<button
						type="button"
						className="obsidian-context-spaces-button obsidian-context-spaces-cta"
						onClick={async () => {
				...
				<div className="obsidian-context-spaces-settings-list">
				...
				<div className="obsidian-context-spaces-setting-item">
					<div className="obsidian-context-spaces-setting-item-info">
						<div className="obsidian-context-spaces-setting-item-name">Help</div>
						<div className="obsidian-context-spaces-setting-item-description">
							Learn how to use Context Spaces.
						</div>
					</div>
					<div className="obsidian-context-spaces-setting-item-control">
						<button
							type="button"
							className="obsidian-context-spaces-button obsidian-context-spaces-cta"
