...
- **Real-time Updates**: Changes in Context Workspaces are immediately reflected in Obsidian's workspace list
...
- **Import Existing Workspaces**: When you first install Context Workspaces, existing Obsidian workspaces are automatically imported as spaces
- **Consistent Experience**: Changes made in Context Workspaces appear immediately in Obsidian's workspace switcher
- **Bidirectional Updates**: Changes made in Obsidian's workspace manager are also reflected in Context Workspaces
...
- **Automatic Workspace Integration**: Context Workspaces automatically integrates with Obsidian's `loadWorkspace` API. When other plugins or scripts use Obsidian's workspace API, Context Workspaces will automatically switch to the corresponding space.
